      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-16 sm:px-8 sm:py-20 space-y-24 sm:space-y-32">
        ...
        <div className="border-b border-white/10 pb-10">
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 mb-8">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border border-white/10 flex-shrink-0">
              <img
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Trix Villaceran</h1>
              <p className="text-sm sm:text-base text-gray-400 mt-1">trixjohn1234@gmail.com</p>
              <p className="text-sm sm:text-base text-gray-500 mt-2">future Fullstack Dev</p>
            </div>
          </div>
        </div>
        ...
        {/* ABOUT */}
        <section id="about">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-300 mb-6">about me</h2>
          ...
          <p className="text-gray-400 leading-relaxed text-sm sm:text-base mt-6">
        ...
        <section id="projects">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-3 sm:gap-0">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-300">featured work</h2>
            <Link href="/projects" className="relative z-20 text-sm text-gray-500 hover:text-gray-300">view all →</Link>
          </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            {projects.map((p) => (
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 sm:p-8 group-hover:bg-white/10 group-hover:border-blue-500/30 transition">
                  <h3 className="text-lg sm:text-xl font-bold text-white">{p.title}</h3>
                  <p className="text-gray-400 mt-3 text-sm sm:text-base">{p.desc}</p>

                  <div className="flex gap-2 mt-4 flex-wrap">
                    {p.tech.map((t) => (
                      <span key={t} className="text-xs sm:text-sm px-2 py-1 rounded text-gray-500 border border-white/10 bg-white/5">
                        {t}
                      </span>
                    ))}
                  </div>
        ...
        {/* SKILLS */}
        <section id="skills">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-300 mb-6">skills</h2>
          <div className="flex flex-wrap gap-3">
            {skills.map((s) => (
              <span key={s} className="px-3 py-1 rounded-full text-sm sm:text-base text-gray-400 border border-white/10">
                {s}
              </span>
            ))}
          </div>
        ...
        <section id="contact" className="border-t border-white/10 pt-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-300 mb-6">contact</h2>
          <p className="text-gray-400 mb-4 text-sm sm:text-base">
            Interested in working together? Feel free to reach out.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="mailto:trixjohn0830@gmail.com" className="text-blue-400 hover:underline">Email</a>
